...
| `GET`   | `/api/auth/google/callback` | Google redirect. Issues the same JWT/refresh cookies as password login. Login creates or links by email; link attaches Google to the signed-in user (emails must match).                                                                                                                                                                                                                                                                     |
