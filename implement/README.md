...
| [`api.md`](./api.md)                           | REST endpoints under `/api/*` (auth, tasks, feed, stories, chat, uploads, admin, queue). |
...
| [`roadmap.md`](./roadmap.md)                   | Phase-by-phase engineering progress (auth, feed, cache/queue, R2 lifecycle, profile fields, chat).             |
