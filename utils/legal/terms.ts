  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "You may stop using the service at any time and delete your own posts, stories, comments, tasks, and epics from the app. There is no self-service account deletion yet: email ducbkdn95@gmail.com from your registered address and the account plus everything it owns will be deleted.",
      ...
      },
      {
        ...
        paragraphs: [
          "These terms may be updated as the service changes. The date at the top of the page shows the current version, and significant changes are announced on the public hub. Continuing to use the service after a change means you accept the new terms; if you do not, stop using the service and ask for your account to be deleted.",
        ],
      },
      {
        id: "governing-law",
  ...
  vi: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Bạn có thể ngừng sử dụng dịch vụ bất cứ lúc nào và tự xoá bài viết, story, bình luận, task, epic của mình trong ứng dụng. Hiện chưa có chức năng tự xoá tài khoản: hãy gửi email tới ducbkdn95@gmail.com từ địa chỉ đã đăng ký, tài khoản cùng toàn bộ dữ liệu thuộc tài khoản sẽ được xoá.",
