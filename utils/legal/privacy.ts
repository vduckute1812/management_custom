...
export const privacyPolicy: LegalDocumentSet = {
  en: {
    ...
    intro: [
      ...
      "It describes what the software actually does. Where a capability does not exist yet — self-service account deletion, for example — this policy says so plainly instead of implying otherwise.",
    ],
    sections: [
      {
        id: "controller",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Deleting your account removes the account row and cascades to your epics, tasks, time blocks, checklist items, timers, posts, comments, reactions, stories, chat messages, uploads, and sessions. Deletion is permanent — there is no recycle bin and no soft delete.",
        ],
      },
      {
        id: "your-choices",
        ...
        paragraphs: [
          "You can edit your profile at any time, and delete your own posts, comments, stories, tasks, and epics from the app. Settings → Your data exports your epics and tasks as JSON, CSV, or an iCal calendar file.",
          "Two limits are honest to state: the built-in export does not yet cover feed posts, chat, stories, or profile data, and there is no self-service account deletion. To get a full copy of your data, to have chat messages removed, or to delete your account, email ducbkdn95@gmail.com from the address on the account. Requests are answered without undue delay and within 30 days at the latest.",
  ...
  vi: {
    ...
    intro: [
      ...
      "Chính sách được viết đúng theo những gì phần mềm thực sự làm. Ở những chỗ tính năng chưa tồn tại — ví dụ tự xoá tài khoản — chính sách nói rõ điều đó thay vì để bạn hiểu sai.",
    ],
    sections: [
      {
        id: "controller",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Xoá tài khoản sẽ xoá bản ghi tài khoản và kéo theo epic, task, khối thời gian, mục checklist, bộ đếm giờ, bài viết, bình luận, biểu cảm, story, tin nhắn, tệp tải lên và các phiên đăng nhập của bạn. Việc xoá là vĩnh viễn — không có thùng rác và không có xoá mềm.",
        ],
      },
      {
        id: "your-choices",
        ...
        paragraphs: [
          "Bạn có thể sửa hồ sơ bất cứ lúc nào, và tự xoá bài viết, bình luận, story, task, epic của mình trong ứng dụng. Cài đặt → Dữ liệu của bạn cho phép xuất epic và task ra JSON, CSV hoặc tệp lịch iCal.",
          "Có hai giới hạn cần nói thẳng: chức năng xuất dữ liệu sẵn có chưa bao gồm bài viết, tin nhắn, story hay dữ liệu hồ sơ, và hiện chưa có chức năng tự xoá tài khoản. Để lấy bản sao đầy đủ dữ liệu, để xoá tin nhắn, hoặc để xoá tài khoản, hãy gửi email tới ducbkdn95@gmail.com từ chính địa chỉ đã đăng ký. Yêu cầu được xử lý không chậm trễ và tối đa trong 30 ngày.",
